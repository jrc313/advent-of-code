  ...
  (for ([monkey monkeys]
    ...
    (for ([item (monkey-items monkey)])
      (let* ([inspected-item ((monkey-inspect monkey) item)]
             [new-item (if relief? (floor (/ inspected-item worry-mod)) (modulo inspected-item worry-mod))]
             [throw-to-monkey-pos ((monkey-throw-to monkey) new-item)]
             [throw-to-monkey (vector-ref monkeys throw-to-monkey-pos)])
